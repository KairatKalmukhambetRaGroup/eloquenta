...
const GoogleButton = ({text}: any) => {
    const handleGoogleLogin = async (e: any) => {
        ...
        // console.log(data)
        try {
            window.location.href = 'https://server.eloquenta.academy/oauth2/authorization/google';
            ...
            //     `https://accounts.google.com/o/oauth2/v2/auth?scope=email%20profile&access_type=offline&include_granted_scopes=true&response_type=code&state=state_parameter_passthrough_value&redirect_uri=https://server.eloquenta.academy/login/oauth2/code/google&client_id=130791195831-hd8336bqc9n6p7k8e3hhjioh8pt5546o.apps.googleusercontent.com`,
